...
;window.Modernizr = function(a, b, c) {
    ...
    }, r = {}, s = {}, t = {}, u = [], v = u.slice, w, x = {}.hasOwnProperty, y;
...
(function() {
    ...
    this.WOW = function() {
        ...
        f.prototype.start = function() {
            ...
            this.boxes = function() {
                var a, c, d, e;
                for (d = this.element.getElementsByClassName(this.config.boxClass),
                e = [],
                a = 0,
                c = d.length; c > a; a++)
                    b = d[a],
...
!function(t, n) {
    ...
    function y(t) {
        ...
        e = m(t[1])) : 4 === t.length && (n = m([t[0], t[1]]),
        e = m([t[2], t[3]])) : "ne"in t && "sw"in t ? (n = m(t.ne),
    ...
    function w(t, n, e, i, a) {
        var r = e ? m(i.td, !1, !0) : !1
          ...
          , l = this;
        s ? (a = a || 0,
        u ? (i.latLng = u.results[0].geometry.location,
        i.results = u.results,
        i.status = u.status,
        n.apply(t, [i])) : (s.location && (s.location = m(s.location)),
        ...
        M().geocode(s, function(o, r) {
            ...
            i.results = o,
            i.status = r,
            n.apply(t, [i])) : r === q.GeocoderStatus.OVER_QUERY_LIMIT && a < A.queryLimit.attempt ? setTimeout(function() {
    ...
    function b(t, n, e) {
        ...
        navigator && navigator.geolocation ? navigator.geolocation.getCurrentPosition(function(i) {
            ...
            e.latLng = !1,
            n.apply(t, [e]))
        }, e.opts.getCurrentPosition) : (e.latLng = !1,
        n.apply(t, [e]))
    }
    function x(t) {
        var n, o = !1;
        ...
        this.get = function(n) {
            if (t.length) {
                ...
                for (o = 0; o < t.length; o++) {
                    for (r = t[o],
                    s = u.length === r.keys.length,
                    i = 0; i < u.length && s; i++)
                        a = u[i],
                        s = a in r.request,
                        s && (s = e(n[a]) && "equals"in n[a] && z(n[a]) ? n[a].equals(r.request[a]) : n[a] === r.request[a]);
                    if (s)
                        return r.results
                }
            }
    ...
    function k() {
        ...
        r.rm = function(t, n, e) {
            ...
            if (n)
                if (e)
                    for (a = o[t].length - 1; a >= 0 && (s = o[t][a],
                    !n(i[s].tag)); a--)
                        ;
                else
                    for (a = 0; a < o[t].length && (s = o[t][a],
                    !n(i[s].tag)); a++)
                        ;
            else
                a = e ? o[t].length - 1 : 0;
    ...
    function T(n, o, i) {
        ...
        function h() {
            if (!x && !I && P) {
                ...
                for (; ; ) {
                    ...
                    l.ref = l.ref.join("-"),
                    l.ref in E ? delete E[l.ref] : (1 === r.length && (O[l.ref] = !0),
                    L(l))
                }
                t.each(E, function(t) {
                    u(t)
        ...
        B.clear = function(t, n, e) {
            ...
            i = _.length,
            a = 1),
            r = o; r !== i && (!_[r] || l && !l(_[r].tag) || (u.push(E[r]),
            !n && !t)); r += a)
                ;
    ...
    function U(i) {
        ...
        function v(n, e) {
            ...
            S ? o && (o.center && (o.center = m(o.center)),
            S.setOptions(o)) : (o = e.opts || t.extend(!0, {}, A.map, o || {}),
            ...
            r.display(function(a) {
                ...
                if (e.force || y > 1)
                    for (c = 0; c < d.length; c++)
                        d[c] <= y && (p = u[d[c]]);
                p ? (h = p.offset || [-p.width / 2, -p.height / 2],
                f = t.extend({}, s),
                f.options = t.extend({
                    pane: "overlayLayer",
        ...
        x.marker = function(n) {
            ...
            return r || (n.opts.position = n.latLng || m(n.opts.position),
            n.td.values = [{
                options: n.opts
            }]),
            n.td.values.length ? (u && v(),
            n.td.cluster && !S.getBounds() ? void q.event.addListenerOnce(S, "bounds_changed", function() {
                x.marker.apply(x, [n])
            }) : void (n.td.cluster ? (n.td.cluster instanceof _ ? (o = n.td.cluster,
            a = I.getById(o.id(), !0)) : (a = w(n.td.cluster),
            ...
            t.each(n.td.values, function(t, e) {
                ...
                o.options.position && (o.options.map = S,
                u && (S.setCenter(o.options.position),
                u = !1),
                a.add(o, e))
            }),
            a.endUpdate(),
            ...
            t.each(n.td.values, function(t, o) {
                ...
                s.options.position && (s.options.map = S,
                u && (S.setCenter(s.options.position),
                u = !1),
        ...
        x.getdistance = function(t) {
            var n;
            for (t.opts.origins = h(t.opts.origins),
            n = 0; n < t.opts.origins.length; n++)
                t.opts.origins[n] = m(t.opts.origins[n], !0);
            for (t.opts.destinations = h(t.opts.destinations),
            n = 0; n < t.opts.destinations.length; n++)
        ...
        x.infowindow = function(e) {
            var o = []
              , r = "values"in e.td;
            r || (e.latLng && (e.opts.position = e.latLng),
            e.td.values = [{
                options: e.opts
            }]),
        ...
        x.circle = function(n) {
            var e = []
              , o = "values"in n.td;
            return o || (n.opts.center = n.latLng || m(n.opts.center),
            n.td.values = [{
                options: n.opts
            }]),
        ...
        x.trafficlayer = function(t) {
            ...
            n || (n = new A.classes.TrafficLayer,
            n.setMap(S),
        ...
        x.bicyclinglayer = function(t) {
            ...
            n || (n = new A.classes.BicyclingLayer,
            n.setMap(S),
        ...
        x.kmllayer = function(n) {
            ...
            n.td.values.length ? (t.each(n.td.values, function(t, o) {
                ...
                S || v(),
                s = d.options,
                d.options.opts && (s = d.options.opts,
        ...
        x.panel = function(n) {
            ...
            n.opts.content && (o = t(n.opts.content),
            u.append(o),
            i.first().prepend(u),
        ...
        x.get = function(e, i, a) {
            var r, s, u = i ? e : e.td;
            return i || (a = u.full),
            o(u) ? (s = I.getById(u, !1, a) || I.objGetById(u),
            s === !1 && (r = u,
            u = {})) : r = u.name,
            "map" === r && (s = S),
            s || (s = [],
            u.id ? (t.each(h(u.id), function(t, n) {
                s.push(I.getById(n, !1, a) || I.objGetById(n))
            }),
            R(u.id) || (s = s[0])) : (t.each(r ? h(r) : [n], function(n, e) {
                var o;
                u.first ? (o = I.get(e, !1, u.tag, a),
                o && s.push(o)) : u.all ? t.each(I.all(e, u.tag, a), function(t, n) {
                    s.push(n)
                }) : (o = I.get(e, !0, u.tag, a),
                o && s.push(o))
            }),
...
var coverVid = function(a, b, c) {
    ...
    function e() {
        var d = a.parentNode.offsetHeight
          ...
          , h = d / g
          , i = e / f;
        i > h ? (a.style.height = "auto",
        a.style.width = e + "px") : (a.style.height = d + "px",
        a.style.width = "auto")
    }
...
window.jQuery && jQuery.fn.extend({
    coverVid: function() {
        return coverVid(this[0], arguments[0], arguments[1]),
        this
    }
});
